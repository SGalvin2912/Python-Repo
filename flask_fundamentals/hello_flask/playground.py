...
# @app.route("/play/<number_of_boxes>/<change_color>")
# def box_color(number_of_boxes,change_color):
#     repeat = (int(number_of_boxes))
#     changeColor = change_color
#     return render_template('playground3.html', repeat = repeat, changeColor = changeColor)
